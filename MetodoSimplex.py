...
#-------------------------------------------------
    ...
    '''
    def encontrarFilaPivote(self):  #OJO VERIFICAR QUE HAYAN POSITIVOS Y QUE NO HAYAN IGUALES MENORES POSITIVOS
    ...
    def start_MetodoSimplex_Max(self):
        ...
        while True:
            ...
            print("- Numero Pivot: "+ str(Fraction(conv))+ ",VB entrante: "+ arregloCol[columnaPivot]+ ",VB saliente: "+ arregloFilas[filaPivot])
            arregloFilas[filaPivot]=arregloCol[columnaPivot]
